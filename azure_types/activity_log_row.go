...
type ActivityLogRow struct {
	...
	// Claims              map[string]*string `json:"claims"` // TODO: #parquet add when we support maps in parquet
	...
	// Properties              map[string]*string `json:"properties"` // TODO: #parquet add when we support maps in parquet
